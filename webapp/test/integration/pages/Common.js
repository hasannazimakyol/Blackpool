sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("mbis/Blackpool/app", ".html");
		...
		return Opa5.extend("mbis.Blackpool.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["mbis/Blackpool/localService/mockserver"], function (mockserver) {
